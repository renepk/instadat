...
function createTableColumns(columnSearch){
...
// create hardcoded javascript object with loan data
...
//generate line chart of two sets of data
var chart = c3.generate({
data: {
        xs: {
            'Current mo prin pd': 'x1',
            'Month': 'x2',
        },
        columns: [
...
(function() {
window.oldloanData=  ['Current mo prin pd', 10,11,32,100,39,13,51,6,13,16,71,5,80];
